...
urlpatterns = [
    path('rsd.xml', RsdXml.as_view(), name='rsd'),
    path('humans.txt', HumansTxt.as_view(), name='humans'),
    path('opensearch.xml', OpenSearchXml.as_view(), name='opensearch'),
    path('wlwmanifest.xml', WLWManifestXml.as_view(), name='wlwmanifest'),
]
